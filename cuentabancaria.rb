...
# número de dígitos distinto a 8. se puede ocupar el método .digits para obtener los dígitos y .count para contarlos
...
puts Cuentabancaria.new('Franco', '00345678', 1).numero_de_cuenta